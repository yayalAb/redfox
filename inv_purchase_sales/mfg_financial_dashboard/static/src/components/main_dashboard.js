...
const DATE_RANGE_OPTIONS = [
    ...
    { value: "this_quarter_qtd", label: "This Quarter (QTD, Eth. FY)" },
    { value: "last_quarter", label: "Last Quarter (Eth. FY)" },
    { value: "this_year_ytd", label: "This Year YTD (Jul 8 – Jul 7)" },
    { value: "last_year", label: "Last Year (Jul 8 – Jul 7)" },
    ...
    async refreshData() {
        ...
        try {
            ...
            Object.assign(this.state, {
                ...
                fiscal_year_label: data.fiscal_year_label || "",
                use_live_data: true,
                kpis: data.kpis || {},
